        ...
        <>
            <div className="container mx-auto p-12 grid grid-cols-1 border-b">
                <div className="w-full grid gap-2 grid-cols-2 ">
                    ...
                    <div className="aspect-square w-12 rounded-full  shadow-md shrink-0 absolute left-1/2 -translate-x-[55%]">
                        <Image src="https://source.unsplash.com/random/?foundation" layout='fill' objectFit='cover' className='rounded-full' alt='foundation' />
                    </div>
