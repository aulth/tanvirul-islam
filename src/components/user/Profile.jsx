...
const Profile = () => {
  ...
  const [data, setData] = useState({ name: "Mohd Usman", username: "mohd.usman_7d3", bio: "Hi, I am Mohd Usman I am pursuing B.Tech Electrical Engineering from Jamia Millia Islamia", title: "Fullstack Developer", course: "B.Tech (Electrical Engineering)", start: "2020", end: "2024" })
            ...
            <div className="w-full items-center grid grid-cols-5 p-4 text-sm">
              ...
              <div className="col-span-3">
                <div className="flex items-center justify-start">
                  ...
                  <select name="end" id="end" value={data.end} onChange={handleOnChange} className="p-1 border focus:outline-none rounded">
                    <option value="2020">2020</option>
                    <option value="2021">2021</option>
                    <option value="2022">2022</option>
                    <option value="2023">2023</option>
