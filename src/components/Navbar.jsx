...
import { BiLogOut, BiMenu, BiUserMinus } from 'react-icons/bi'
        ...
        <>
            <div className="w-screen bg-transparent">
                <div className="container mx-auto flex justify-between items-center p-4 md:py-0">
                    ...
                    <ul className={`flex ${openedMenu ? '' : 'md:flex hidden'} text-sm z-10 transition duration-75 menu gap-2 flex-col items-center md:flex-row absolute left-0 top-[65.38px] md:static md:bg-none md:border-none border-b-2 border-black bg-gradient-to-br from-[#FEFDFC] to-[#F8F7EE] md:w-auto w-full md:p-0 p-4 pt-0`}>
